...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--line)] py-10 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Izquierda */}
        <div className="flex items-center gap-4">
          <span className="font-display text-xl text-[var(--paper)]">
            JAY<span className="text-[var(--ember)]">ART</span>
          </span>
        ...
        <p className="font-mono text-[0.65rem] text-[var(--steel)]">
          ...
          <a
            ...
            className="text-[var(--paper-dim)] hover:text-[var(--paper)] transition-colors"
          >
            Rupta Studios
          </a>
        </p>
